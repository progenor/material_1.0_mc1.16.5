...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    TUNGSTEN("tungsten", 55, new int[]{4, 7, 9, 4}, 19,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 6.0F, 1.1F, () -> {
        return Ingredient.fromItems(ModItems.THUNGSTEN_INGOT.get());
    });
    ...
    public String getName() {
        return Materials.MOD_ID + ":" + this.name;
    }
